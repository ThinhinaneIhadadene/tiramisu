...
int main(int, char**) {
    ...
    Halide::Buffer<uint8_t> input(3, _COLS/NODES, _ROWS );
    Halide::Buffer<uint8_t> output_ref(_COLS/NODES, _ROWS);
    Halide::Buffer<uint8_t> output(_COLS/NODES, _ROWS);

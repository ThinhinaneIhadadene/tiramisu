...
int main(int argc, char **argv) {
    ...
    buffer b_input("b_input", {_ROWS/_NODES + 2, tiramisu::expr(_COLS) + 2}, p_uint32, a_input, &blur);
    buffer b_blurx("b_blurx", {_ROWS/_NODES, tiramisu::expr(_COLS) + 2}, p_uint32, a_temporary, &blur);
    buffer b_blury("b_blury", {_ROWS/_NODES, tiramisu::expr(_COLS)}, p_uint32, a_output, &blur);
    ...
    blur.codegen({&b_input, &b_blury}, "build/generated_fct_blurautodist.o");

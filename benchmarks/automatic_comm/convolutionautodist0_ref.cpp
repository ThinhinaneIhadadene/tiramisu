...
{
    tiramisu::init("convolutionautodist0_ref");
    ...
    data_transfer.r->before(conv, computation::root);
    ...
    tiramisu::codegen({&buff_input, &buff_kernel, &buff_convolution} ,"build/generated_fct_convolutionautodist0_ref.o");

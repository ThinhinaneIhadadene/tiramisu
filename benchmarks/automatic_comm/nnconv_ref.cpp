...
int main(int argc, char **argv)
{
    ...
    buffer b_input("b_input", {_BATCH_SIZE,_N,_N, _FIN}, p_int32, a_input, &nnconv);
    buffer b_bias("b_bias", {_FOUT_NB_BLOCKS,_FOUT_BLOCKING}, p_int32, a_input, &nnconv);
    buffer b_blury("b_blury", {_BATCH_SIZE, _FOUT_NB_BLOCKS, _N, _N, _FOUT_BLOCKING}, p_int32, a_output, &nnconv);
